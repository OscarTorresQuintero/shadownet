...
class _RadarScreenState extends State<RadarScreen>
  ...
  static const double _activationRadius = 500.0;
  ...
  double _calcularDistancia(double lat1, double lon1,
  ...
  void _updateNodes(Position userPos) {
    ...
    for (final node in _nodes) {
      ...
      node.status = dist <= _activationRadius
          ? NodeStatus.nearby
          : NodeStatus.locked;
  ...
  void _abrirMision(MissionNode node) async {
  ...
  Widget _buildTopBar() => Padding(
    ...
    child: Column(
      ...
      children: [
            ...
            AnimatedBuilder(
              ...
              builder: (_, _) => Transform.rotate(
                ...
                child: const Icon(Icons.radar,
                    color: TerminalTheme.primaryGreen, size: 20),
              ),
            ),
            const SizedBox(width: 8),
            Text('GEO-RADAR DE NODOS',
                style: TerminalTheme.terminalTitle.copyWith(fontSize: 14)),
            const Spacer(),
            Text(
        ...
        Text(_statusLine, style: TerminalTheme.terminalSmall),
  ...
  Widget _buildMapa() => Container(
    margin: const EdgeInsets.symmetric(horizontal: 8),
    decoration: BoxDecoration(
      border: Border.all(color: TerminalTheme.dimGreen.withOpacity(0.4)),
    ),
    child: FlutterMap(
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (_, _) => Container(
                    decoration: BoxDecoration(
                      ...
                      color: TerminalTheme.cyan.withOpacity(
                        0.2 + _pulseController.value * 0.3,
                      ),
                      border: Border.all(color: TerminalTheme.cyan, width: 2),
                    ),
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: TerminalTheme.bgColor.withOpacity(0.8),
                        border: Border.all(
                          color: node.status == NodeStatus.completed
                              ? TerminalTheme.cyan
                              : node.status == NodeStatus.nearby
                                  ? TerminalTheme.primaryGreen
                                  : TerminalTheme.dimGreen.withOpacity(0.4),
                        ),
                      ),
                      child: Text(
                        node.id,
  ...
  Widget _buildListaNodos() => SizedBox(
    height: 110,
    child: ListView.builder(
      ...
      itemBuilder: (_, i) {
        ...
        final cardColor   = isCompleted
            ...
            : isNearby
                ? TerminalTheme.primaryGreen
                : TerminalTheme.dimGreen.withOpacity(0.3);
  ...
  Widget _buildBottomBar() => Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        Text(
          '${_nodes.where((n) => n.status == NodeStatus.completed).length}'
          '/${_nodes.length} COMPLETADOS',
          style: TerminalTheme.terminalSmall
